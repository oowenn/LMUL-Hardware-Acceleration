...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --cpu-static-power-mw)
            ...
            ;;
        -h|--help)
            echo "Usage: $0 [--size N] [--pe-rows R] [--pe-cols C] [--cpu-clock FREQ] [--accel-clock FREQ] [--cpu-model MODEL] [--output-dir DIR] [--log-file FILE] [--no-output-extraction] [--include-cpu-lmul] [--disable-cpu-power-model]"
            echo
            ...
            echo "  - --cpu-clock FREQ: CPU clock frequency (default: ${CPU_CLOCK})"
            ...
            echo "  - Env: CPU_CLOCK=3.2GHz is equivalent to --cpu-clock 3.2GHz"
