...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("N_W1", 32, hls_in, 8, "ap_none", "in_data", 1),
	Port_Property("N_W2", 32, hls_in, 9, "ap_none", "in_data", 1),
	Port_Property("K", 32, hls_in, 10, "ap_none", "in_data", 1),
};
const char* HLS_Design_Meta::dut_name = "qwen_superblock";
