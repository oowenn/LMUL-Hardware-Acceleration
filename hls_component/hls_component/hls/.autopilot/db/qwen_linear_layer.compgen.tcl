...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler qwen_superblock_qwen_linear_layer_bufA_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler qwen_superblock_qwen_linear_layer_bufC_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
