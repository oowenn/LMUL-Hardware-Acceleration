...
`timescale 1ns/1ps
(* DowngradeIPIdentifiedWarnings="yes" *) module qwen_superblock_temp_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 16,
    AddressRange = 1792,
    AddressWidth = 11,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        qwen_superblock_temp_RAM_AUTO_1R1W_memcore qwen_superblock_temp_RAM_AUTO_1R1W_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .address0 ( buf_a0[i] ),
            .we0      ( buf_we0[i] ),
            .d0       ( buf_d0[i] ),
