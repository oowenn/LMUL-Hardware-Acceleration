...
HLS_SOURCES = ../../../../superblock_tb.cpp ../../../../hello.cpp
...
$(ObjDir)/superblock_tb.o: ../../../../superblock_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../superblock_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/superblock_tb.d

$(ObjDir)/hello.o: ../../../../hello.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../hello.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=qwen_superblock $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/hello.d
